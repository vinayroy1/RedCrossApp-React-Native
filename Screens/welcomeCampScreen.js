...
function WelcomeCampScreenComponent({ navigation }) {
    return (
...
const WelcomeCampScreen = () => {
    return (
        <Stack.Navigator>
            <Stack.Screen name="WelcomeCamp" component={WelcomeCampScreenComponent} />
...
export default WelcomeCampScreen;